...
public class BasePage {
    ...
    public void inputTextTo(Object webObject, String value) {
        ...
        // Add Report
        addReportInfo(lession15.common.LogType.INFO, MessageFormat.format("Input text {0} to {1}", value, element));
    }
    ...
    public void clickElement(Object webObject) {
        ...
        // Add report
        addReportInfo(lession15.common.LogType.INFO, MessageFormat.format("Clicked  {0}", element));
    }
     ...
     * @param extMsg
     */
    public static void addReportInfo(lession15.common.LogType logType, String extMsg) {
